...
export default function OneTimeResult({ oneTimeData, resultText }) {
    return (
        <dialog id="oneTime-modal" className="modal">
            <div className="modal-box bg-gradient-to-br from-cyan-200 to-fuchsia-200">
                ...
                <h3 className="font-bold text-xl text-blue-500">One Time Pad Cipher</h3>
                <div className="py-5 font-semibold">
                    <p>Given Text: <span className="font-normal">{oneTimeData?.plainText}</span></p>

...
export default function VigenereResult({ vigenereData, resultText }) {
    return (
        <dialog id="vigenere-modal" className="modal">
            <div className="modal-box bg-gradient-to-br from-cyan-200 to-fuchsia-200">
                ...
                <h3 className="font-bold text-xl text-blue-500">Vigenere Cipher</h3>
                <div className="py-5 font-semibold">
                    <p>Given Text: <span className="font-normal">{vigenereData?.plainText}</span></p>
